        ...
        <div class="conteinerheader">
            <div class="tabs">
                <input type="radio" id="radio1" name="tabs">
                 <label for="radio1" class="tab"><a href="home.html">home</a> </label>
                <input type="radio" id="radio2" name="tabs">
                <label for="radio2" class="tab" ><a href="login.html">login</a></label>
                <input type="radio" id="radio3" name="tabs">
                <label for="radio3" class="tab"><a href="singup.html">singup</a></label>
